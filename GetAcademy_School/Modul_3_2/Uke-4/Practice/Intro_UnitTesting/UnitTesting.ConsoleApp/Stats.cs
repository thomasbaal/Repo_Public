...
namespace UnitTesting.ConsoleApp
{
    public class Stats
    {
        ...
        private string Format(string label, float? number)
        {
            return number == null ? string.Empty : 
                FormatImpl(label, number.Value.ToString("####.##"));
        }

        private string Format(string label, int? number)
        {
            return number == null ? string.Empty : 
                FormatImpl(label, number.Value.ToString("####"));
        }

        private string FormatImpl(string label, string number)
        {
